...
namespace Valve.VR
{
    public class SteamVR : System.IDisposable
    {
        ...
        public static void ShowBindingsForEditor()
        {
            ...
            var bindingFlagError = Valve.VR.EVRSettingsError.None;
        ...
        public static string GetResourcesFolderPath(bool fromAssetsDirectory = false)
        {
            ...
            var scriptAsset = UnityEditor.MonoScript.FromScriptableObject(asset);

            var scriptPath = UnityEditor.AssetDatabase.GetAssetPath(scriptAsset);

            var fi = new System.IO.FileInfo(scriptPath);
            var rootPath = fi.Directory.Parent.ToString();

            var resourcesPath = System.IO.Path.Combine(rootPath, "Resources");
        ...
        private static string GetManifestFile()
        {
            ...
            if (File.Exists(fullPath))
            {
                ...
                var existingFile = Valve.Newtonsoft.Json.JsonConvert.DeserializeObject<SteamVR_Input_ManifestFile>(jsonText);
            ...
            if (File.Exists(fullPath) == false)
            {
                ...
                */
                ...
                var json = Valve.Newtonsoft.Json.JsonConvert.SerializeObject(manifestFile, Valve.Newtonsoft.Json.Formatting.Indented,
