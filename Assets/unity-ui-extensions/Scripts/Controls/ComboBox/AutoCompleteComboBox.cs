...
namespace Scripts.Controls.ComboBox
{
    ...
    public class AutoCompleteComboBox : MonoBehaviour
    {
        ...
        */
        ...
        private void RebuildPanel()
        {
            ...
            for (var i = 0; i < itemObjs.Count; i++)
            {
                ...
                if (i < AvailableOptions.Count)
                {
                    ...
                    var textOfItem = _panelItems[i]; //has to be copied for anonymous function or it gets garbage collected away
        ...
        {
            var scrollbarWidth = _panelItems.Count > ItemsToDisplay ? _scrollBarWidth : 0f;//hide the scrollbar if there's not enough items
