	...
	public class DropDownList : MonoBehaviour
	{
		...
		*/
		...
		private void RebuildPanel()
		{
			...
			{
				var newItem = Instantiate(_itemTemplate) as GameObject;
		...
		{
			var scrollbarWidth = Items.Count > ItemsToDisplay ? _scrollBarWidth : 0f;//hide the scrollbar if there's not enough items
