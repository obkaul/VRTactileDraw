...
namespace Scripts.Primitives
{
    ...
    public class UICircle : UIPrimitiveBase
    {
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            var inner = -rectTransform.pivot.x * rectTransform.rect.width + this.m_thickness;
            ...
            if (FixedToSegments)
            {
                var f = (this.m_fillPercent / 100f);
                var degrees = 360f / m_segments;
                var fa = (int)((m_segments + 1) * f);
            ...
            else
            {
                ...
                var angleByStep = (m_fillPercent / 100f * (Mathf.PI * 2f)) / m_segments;
                var currentAngle = 0f;
                for (var i = 0; i < m_segments + 1; i++)
                {
