...
namespace Scripts.Layout
{
    ...
    public class UIVerticalScroller : MonoBehaviour
    {
        ...
        public void ScrollUp()
        {
            ...
            var newPositionUp = new Vector2(_scrollingPanel.anchoredPosition.x, _scrollingPanel.anchoredPosition.y - deltaUp);
        ...
        public void ScrollDown()
        {
            ...
            var newPositionDown = new Vector2(_scrollingPanel.anchoredPosition.x, _scrollingPanel.anchoredPosition.y + deltaDown);
