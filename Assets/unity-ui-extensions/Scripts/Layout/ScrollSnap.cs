...
namespace Scripts.Layout
{
    ...
    public class ScrollSnap : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollSnap
    {
        ...
        private void NextScreenCommand()
        {
            ...
            {
                var targetPage = Mathf.Min(_pages - 1, _pageOnDragStart + ItemsVisibleAtOnce);
                _lerp = true;
        ...
        private void PrevScreenCommand()
        {
            ...
            {
                var targetPage = Mathf.Max(0, _pageOnDragStart - ItemsVisibleAtOnce);
                _lerp = true;
