...
namespace Scripts.Effects
{
    ...
    public class MonoSpacing : BaseMeshEffect
	{
        ...
        public override void ModifyMesh(VertexHelper vh)
        {
			...
			// Vector3  pos;
			var    letterOffset    = Spacing * (float)text.fontSize / 100f;
			...
			for (var lineIdx=0; lineIdx < lines.Length; lineIdx++)
			{
                ...
                var lineOffset = (line.Length - 1) * letterOffset * (alignmentFactor) - (alignmentFactor - 0.5f) * rectTransform.rect.width;
				...
				for (var charIdx = 0; charIdx < line.Length; charIdx++)
				{
                    ...
                    var charWidth = (vert2.position - vert1.position).x;
