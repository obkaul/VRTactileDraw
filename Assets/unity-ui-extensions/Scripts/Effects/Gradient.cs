    ...
    public class Gradient : BaseMeshEffect
    {
        ...
        public override void ModifyMesh(VertexHelper vh)
        {
            ...
            if (_gradientMode == GradientMode.Global)
            {
                ...
                var bottomY = _gradientDir == GradientDir.Vertical ? vertexList[vertexList.Count - 1].position.y : vertexList[vertexList.Count - 1].position.x;
                var topY = _gradientDir == GradientDir.Vertical ? vertexList[0].position.y : vertexList[0].position.x;
