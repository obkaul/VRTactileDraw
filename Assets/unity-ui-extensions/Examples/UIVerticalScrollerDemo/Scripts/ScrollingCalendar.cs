...
namespace Examples.UIVerticalScrollerDemo.Scripts
{
    public class ScrollingCalendar : MonoBehaviour
    {
        ...
        {
            var currentYear = int.Parse(System.DateTime.Now.ToString("yyyy"));
            ...
            for (var i = 0; i < arrayYears.Length; i++)
            {
                ...
                var clone = (GameObject)Instantiate(yearsButtonPrefab, new Vector3(0, i * 80, 0), Quaternion.Euler(new Vector3(0, 0, 0))) as GameObject;
        ...
        private void InitializeMonths()
        {
            ...
            for (var i = 0; i < months.Length; i++)
            {
                ...
                var clone = (GameObject)Instantiate(monthsButtonPrefab, new Vector3(0, i * 80, 0), Quaternion.Euler(new Vector3(0, 0, 0))) as GameObject;
        ...
        private void InitializeDays()
        {
            ...
            {
                days[i] = i + 1;
                var clone = (GameObject)Instantiate(daysButtonPrefab, new Vector3(0, i * 80, 0), Quaternion.Euler(new Vector3(0, 0, 0))) as GameObject;
