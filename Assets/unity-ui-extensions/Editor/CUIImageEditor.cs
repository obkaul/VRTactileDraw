...
namespace UnityEngine.UI.Extensions
{
    ...
    public class CUIImageEditor : CUIGraphicEditor
    {
        public override void OnInspectorGUI()
        {
            ...
            var script = (CUIImage)this.target;
            ...
            var newCornerRatio = EditorGUILayout.Vector2Field("Corner Ratio", script.cornerPosRatio);
        ...
        protected override void OnSceneGUI()
        {
            ...
            if (script.UIImage.type == Image.Type.Sliced || script.UIImage.type == Image.Type.Tiled)
            {
                ...
                EditorGUI.BeginChangeCheck();
                var newCornerPos = Handles.FreeMoveHandle(script.transform.TransformPoint(cornerPos), script.transform.rotation, HandleUtility.GetHandleSize(script.transform.TransformPoint(cornerPos)) / 7, Vector3.one, Handles.SphereHandleCap);
